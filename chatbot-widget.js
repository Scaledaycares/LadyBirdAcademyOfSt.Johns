...
function startConversation() {
    fetch('https://chatbot-for-lady-bird-academy-of-st-johns-samuelsicking.replit.app/start', {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
...
document.getElementById('chat-form').addEventListener('submit', function(event) {
    ...
    fetch('https://chatbot-for-lady-bird-academy-of-st-johns-samuelsicking.replit.app/chat', {
        method: 'POST',
        headers: {
...
function sendToGas4(message, isUserMessage) {
    ...
    const GAS_URL4 = 'https://script.google.com/macros/s/AKfycbyv4TK255IQRz_NT8iLlTvJgs1tTz3696prV-13KU8G_PUKnO6hb81DaS37NII7nnoV/exec';
